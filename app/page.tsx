...
import { ChevronRight, Calendar, Trophy, Flag, Play, Menu, X } from 'lucide-react';
...
const F1Homepage = () => {
  ...
  const heroSlides = [
    ...
    },
    {
      ...
      image: "https://cdn-wp.thesportsrush.com/2024/11/a9c244ca-monaco-gp-hairpin.jpg?format=auto&w=1080&q=75",
      cta: "Race Preview"
    },
    {
      title: "DRIVER STANDINGS",
      subtitle: "Championship Battle Heats Up",
      image: "https://e0.365dm.com/23/05/2048x1152/skysports-f1-miami-gp-graphic_6139784.png?20230501105349",
      cta: "View Standings"
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-2xl">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                Experience the pinnacle of motorsport with unparalleled speed, precision, and drama.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl md:text-6xl font-black text-red-600 mb-2">23</div>
              <div className="text-gray-400 uppercase tracking-wide">Races</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-6xl font-black text-red-600 mb-2">20</div>
              <div className="text-gray-400 uppercase tracking-wide">Drivers</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-6xl font-black text-red-600 mb-2">10</div>
              <div className="text-gray-400 uppercase tracking-wide">Teams</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-6xl font-black text-red-600 mb-2">350+</div>
      ...
      <div className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-black mb-6">Constructor Standings</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
Follow the intense battle between the world&rsquo;s most prestigious racing teams
            </p>
          </div>
            ...
            {teams.map((team, index) => (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-black text-red-400">{team.wins * 25}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="py-20 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-black mb-6">Race Calendar</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
Don&rsquo;t miss a single moment of the championship battle
      ...
      <div className="py-20 bg-gradient-to-r from-red-600 to-red-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-6xl font-black mb-6">Never Miss a Race</h2>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90">
            Get live updates, exclusive content, and behind-the-scenes access to Formula 1
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="text-3xl font-black text-red-600 mb-4">FORMULA 1</div>
              <p className="text-gray-400 mb-6 max-w-md">
                The official home of Formula 1. Experience the speed, passion, and drama of the worlds premier motorsport championship.
              </p>
            ...
            <div>
              <h3 className="text-white font-bold mb-4 uppercase tracking-wide">Championship</h3>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white transition-colors">Driver Standings</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Constructor Standings</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Race Results</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Statistics</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-white font-bold mb-4 uppercase tracking-wide">Experience</h3>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white transition-colors">Live Timing</a></li>
                <li><a href="#" className="hover:text-white transition-colors">F1 TV</a></li>
